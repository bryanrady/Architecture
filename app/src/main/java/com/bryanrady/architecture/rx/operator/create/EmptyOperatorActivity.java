...
public class EmptyOperatorActivity extends BaseActivity {
    ...
    public void initView(View view) {
        ...
        tv_operator_name.setText("empty");
        tv_operator_effect.setText("empty用于创建一个不发射任何事件但正常终止的被观察者");
    }

    private void initToolbar() {
        llBack.setVisibility(View.VISIBLE);
        tvToolbarTitle.setText("创建型操作符---empty");
        mToolbar.setTitle("");
    ...
    private void testOperator(){
        tv_send.append("Observable send : empty()" + "\n");
        Observable.<String>empty().subscribe(new Observer<String>() {
            ...
            public void onNext(String s) {
                tv_receive.append("Observable receive : onNext " + s + "\n");
            }
            ...
            public void onComplete() {
                tv_receive.append("Observable receive : onComplete " + "\n");
            }
        });
