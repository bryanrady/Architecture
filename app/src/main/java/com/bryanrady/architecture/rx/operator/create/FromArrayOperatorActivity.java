...
public class FromArrayOperatorActivity extends BaseActivity {
    ...
    public void initView(View view) {
        ...
        tv_operator_name.setText("fromArray");
        tv_operator_effect.setText("fromArray用于快速创建一个被观察者，接收一个数组，然后直接发送数组的数据");
    }

    private void initToolbar() {
        llBack.setVisibility(View.VISIBLE);
        tvToolbarTitle.setText("创建型操作符---fromArray");
        mToolbar.setTitle("");
    ...
    private void testOperator(){
        ...
        tv_send.append("Observable send : hehe!" + "\n");
        Observable.fromArray(new String[]{"hello","world","hehe!"})
