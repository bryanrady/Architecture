...
public class IsEmptyOperatorActivity extends BaseActivity {
    ...
    public void initView(View view) {
        ...
        tv_operator_name.setText("IsEmpty");
        tv_operator_effect.setText("判断被观察者发送的数据是否为空");
    }

    private void initToolbar() {
        llBack.setVisibility(View.VISIBLE);
        tvToolbarTitle.setText("条件操作符---IsEmpty");
        mToolbar.setTitle("");
        ...
        Observable.just(1,2,3,4)
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean aBoolean) throws Exception {
                        tv_receive.append("Consumer receive : 判断发送的数据是否为空 :" + aBoolean + "\n");
                    }
                });
    }
