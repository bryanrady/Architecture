...
public class ContainsOperatorActivity extends BaseActivity {
    ...
    public void initView(View view) {
        ...
        tv_operator_name.setText("Contains");
        tv_operator_effect.setText("判断发送的数据中是否 包含指定数据 ");
    }

    private void initToolbar() {
        llBack.setVisibility(View.VISIBLE);
        tvToolbarTitle.setText("条件操作符---Contains");
        mToolbar.setTitle("");
        ...
        Observable.just(1,2,3,4)
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean aBoolean) throws Exception {
                        tv_receive.append("Consumer receive : 是否包含4 :" + aBoolean + "\n");
                    }
                });
    }
